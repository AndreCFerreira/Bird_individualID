...
This repository provides the necessary guidance for the implementation of our paper ”Individual visual identification using deep learning in wild birds”. Moroever, here we provide a step-by-step on how to automatize the collection of training pictures using RFID technology in birds, pre-process the obtained images and train convolutional neural networks for individual identification. The tutorials presented in this repository are meant for researchers with basic programing skills, more specificly python language.
